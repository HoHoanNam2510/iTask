/* server/utils/zegoServerAssistant.ts */
...
export function generateToken04(
  ...
  // Xử lý BigInt an toàn
  const expireBigInt = BigInt(tokenInfo.expire);
  new DataView(b1.buffer).setBigInt64(0, expireBigInt, false);
